...
class AccessTokenGuard implements Guard
{
	...
	public function __construct (UserProvider $provider, Request $request, $configuration) {
		...
		$this->inputKey = isset($configuration['input_key']) ? $configuration['input_key'] : 'AccessToken';
		// key to check in database
		$this->storageKey = isset($configuration['storage_key']) ? $configuration['storage_key'] : 'AccessToken';
    }
